                        ...
                        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                            <?php if(auth()->guard()->check()): ?>
                                    ...
                                    < <form action="<?php echo e(route('logout')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <a class="text-sm text-gray-700 dark:text-gray-500 underline" href="<?php echo e(route('logout')); ?>"
                ...
                <?php if(Auth::user()->utype == 'ADM'): ?>
                    <li class="nav-item">
                        <a class=" nav-item nav-link active text-white fs-4" aria-current="page"
                            href="<?php echo e(route('AdminDashboard')); ?>">Dashboard</a>
                    </li>
                <?php else: ?>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-white fs-4" aria-current="page"
                            href="<?php echo e(route('product')); ?>">Product</a>
                    </li>
...
<?php /**PATH C:\Users\Dell\Desktop\6th Sem Project\agroproject\resources\views/master/header.blade.php ENDPATH**/ ?>